 ...
 *  @version    1.4 (last revision: July 08, 2012)
    ...
    $.Zebra_DatePicker = function(element, options) {
        ...
        var init = function(update) {
            ...
            var
                ...
                // system date)
                reference_date = (!plugin.settings.reference_date ? date : plugin.settings.reference_date),
        ...
        var update_dependent = function(date) {
            ...
            // if a date picker exists which has the starting date depending on the value of the current date picker
            if (plugin.settings.pair && plugin.settings.pair.data && plugin.settings.pair.data('Zebra_DatePicker')) {
