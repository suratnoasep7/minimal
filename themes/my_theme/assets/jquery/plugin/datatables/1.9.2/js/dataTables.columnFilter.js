...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateInput(oTable, regex, smart, bIsNumber, iFilterLength, iMaxLenght) {
            ...
            var input = $('<input type="text" class="span12 ' + search_init + sCSSClass + '" value="' + inputvalue + '"/>');
        ...
        function fnCreateDateRangeInput(oTable) {
            th.html(_fnRangeLabelPart(0));
            var sFromId = oTable.attr("id") + '_range_from_' + i;
            var from = $('<input type="text" class="span12 date_range_filter" id="' + sFromId + '" rel="' + i + '"/>');
            from.datepicker();
            th.append(from);
            th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<input type="text" class="span12 date_range_filter" id="' + sToId + '" rel="' + i + '"/>');
            th.append(to);
            th.append(_fnRangeLabelPart(2));
            th.wrapInner('<span class="span12 filterColumn filter_date_range" />');
            to.datepicker();
            var index = i;
            aiCustomSearch_Indexes.push(i);
        ...
        return this.each(function () {
            ...
            for (j = 0; j < aiCustomSearch_Indexes.length; j++) {
                ...
                var fnSearch_ = function () {
					...
					if (($("#" + id + "_range_from_" + aiCustomSearch_Indexes[j]).val()!='') &&($("#" + id + "_range_to_" + aiCustomSearch_Indexes[j]).val()!=''))
					{
