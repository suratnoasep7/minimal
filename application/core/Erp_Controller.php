 ...
 *
 */
class Erp_Controller extends Base_Controller
{
    ...
    public function __construct()
    {
		...
		Template::set_theme('my_theme', 'kioslinecom');
    }//end __construct()

    //--------------------------------------------------------------------
	public function dropdown_opt_generate($opt_name="",$opt_key="",$opt_caption="",$opt_table="",$opt_add="",$opt_condition="",$opt_select2=FALSE,$opt_all=FALSE) //tambah
	{
