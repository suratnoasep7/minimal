...
if (!function_exists('pageHeader')) {
	function pageHeader($toolbar_title, $targetModal)
	{
		$return = "";
		$return .= '<div class="page-header">';
		$return .= '<div class="row align-items-center">';
		$return .= '<div class="col">';
		$return .= '<h3 class="page-title">' . $toolbar_title . '</h3>';
		$return .= '</div>';
		$return .= '<div class="col-auto float-end ms-auto">';
		$return .= '<a href="#" class="btn add-btn" data-bs-toggle="modal" data-bs-target="#' . $targetModal . '"><i class="fa fa-plus"></i> Add New</a>';
		$return .= '</div>';
		$return .= '</div>';
		$return .= '</div>';
		return $return;
...
if (!function_exists('openCard')) {
	function openCard($col = "col-md-12")
	{
		$return = "";
		$return .= '<div class="' . $col . ' d-flex">';
		$return .= '<div class="card flex-fill">';
...
if (!function_exists('LumaOptionLabel')) {
	function LumaOptionLabel($label, $name, $list_option, $value, $atribut, $colboostrap = "")
	{
		$return = '<div class="form-group ' . $colboostrap . '">';
		$return .= '<div class="col-sm-12"  style="padding:0px;">';
		$return .= form_dropdown($name, $list_option, $value, $label,  $atribut);
