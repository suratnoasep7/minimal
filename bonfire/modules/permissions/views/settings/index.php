		...
		<table class="table table-striped">
			<thead>
				<tr>
					...
					<th>Modul</th>
					<th><?php echo lang('permissions_type'); ?></th>
				</tr>
			</thead>
			<tfoot>
				<tr>
			...
			<tbody>
				<?php 
					// tidak digunakan karena ambil dari database
					// $optionstype = array(
					// 	'0'		=> 'Proses',
					// 	'1'		=> 'Transaksi',
					// 	'2'		=> 'Report',
				...
				<tr>
					...
					<!-- <td><?php // echo $optionstype[$record->type_id]; ?></td> tidak digunakan karena ambil dari database -->
