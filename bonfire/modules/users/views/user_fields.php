...
<div class="control-group<?php echo form_error('email') ? $errorClass : ''; ?>">
    ...
    <div class="controls">
        <input class="form-control required" type="text" id="email" name="email" value="<?php echo set_value('email', isset($user) ? $user->email : ''); ?>" />
...
<div class="control-group<?php echo form_error('display_name') ? $errorClass : ''; ?>">
    ...
    <div class="controls">
        <input class="form-control required" type="text" id="display_name" name="display_name" value="<?php echo set_value('display_name', isset($user) ? $user->display_name : ''); ?>" readonly/>
...
<div>
    ...
    <div class="controls">
        <input class="form-control required" type="text" value="<?php echo set_value('cabang', isset($user) ? $user->cabang : ''); ?>" readonly />
...
<div class="control-group<?php echo form_error('username') ? $errorClass : ''; ?>">
    ...
    <div class="controls">
        <input class="form-control required" type="text" id="username" name="username" value="<?php echo set_value('username', isset($user) ? $user->username : ''); ?>" readonly />
...
<div class="control-group<?php echo form_error('password') ? $errorClass : ''; ?>">
    ...
    <div class="controls">
        <input class="form-control required" type="password" id="password" name="password" value="" readonly />
...
<div class="control-group<?php echo form_error('pass_confirm') ? $errorClass : ''; ?>">
    ...
    <div class="controls">
        <input class="form-control required" type="password" id="pass_confirm" name="pass_confirm" value="" readonly />
