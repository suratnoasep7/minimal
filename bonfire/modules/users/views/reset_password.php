...
<div class="controls">
<input class="form-control required" type="password" name="password" id="password" value="" placeholder="Password...." />
...
<div class="controls">
<input class="form-control required" type="password" name="pass_confirm" id="pass_confirm" value="" placeholder="<?php echo lang('bf_password_confirm'); ?>" />
</div>
</div>
